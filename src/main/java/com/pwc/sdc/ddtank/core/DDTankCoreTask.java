...
import com.pwc.sdc.ddtank.config.DDTankSetting;
import com.pwc.sdc.ddtank.core.impl.*;
import com.pwc.sdc.ddtank.entity.LevelRule;
import com.pwc.sdc.ddtank.exception.StopTaskException;
import com.pwc.sdc.ddtank.handler.DDTankAutoUsePropHandler;
import com.pwc.sdc.ddtank.handler.DDTankSelectMapHandler;
import com.pwc.sdc.ddtank.handler.DDTankAutoCompleteHandler;
import com.pwc.sdc.ddtank.handler.impl.DDTankAutoUsePropHandlerImpl;
import com.pwc.sdc.ddtank.core.impl.DDTankCoreAttackHandlerImpl;
import com.pwc.sdc.ddtank.handler.impl.DDTankSelectMapHandlerImpl;
import com.pwc.sdc.ddtank.handler.impl.DDTankAutoCompleteHandlerImpl;
import com.pwc.sdc.ddtank.type.CoreThreadStateEnum;
import com.pwc.sdc.ddtank.util.DDTankComplexObjectUpdateUtils;
...
public class DDTankCoreTask implements Runnable, Serializable {
                    ...
                    if (suspend) {
                        ...
                        try {
                            ...
                            if (ddtankPic.needDraw()) {
                                ...
                                // 执行固定延迟
                                ThreadUtils.delay((long) (properties.getLevelEndWaitTime() * 1000), true);
                            }
    ...
    public boolean bind(Library dm) {
        ...
        if (dm.bindWindowEx(hwnd, properties.getBindDisplay(), properties.getBindMouse(), properties.getBindKeypad(), properties.getBindPublic(), properties.getBindMode())) {
            ThreadUtils.delayPersisted(1000, false);
            return true;
        }
        return false;
    }
