...
import com.pwc.sdc.ddtank.exception.DDTankStrengthResolveException;
import com.pwc.sdc.ddtank.core.DDTankOperate;
    ...
    public void attack2(double strength) {
        ...
        if (ddTankPic.isMyRound()) {
            ...
            while (true) {
                        ...
                        while (checkColor.equalsIgnoreCase(color)) {
                            ...
                            if (properties.getAftertreatment()) {
                                ...
                                for (int i = 0; i < properties.getAftertreatmentSec(); i++) {
                                    ...
                                    ThreadUtils.delay(1000 / properties.getAftertreatmentSec(), true);
                                }
                            } else {
                ...
                ThreadUtils.delay(properties.getStrengthCheckDelay(), true);
            }
        }
    }
